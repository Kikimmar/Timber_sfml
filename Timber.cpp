...
int main()
{
	...
	textureTree1.loadFromFile("resources/graphics/tree.png");
	...
	// Variebles to control time itself
	Clock clock;
	...
	timeBar.setPosition((float)(1920 / 2) - timeBarStartWidth / 2, 980);

	Time gameTimeTotal;
	float timeRemaining = 6.0f;
	float timeBarWidthPerSecond = timeBarStartWidth / timeRemaining;

	//Track whether the game is runnung
	bool paused = true;
	...
	// Some othe useful log related variables
	...
	outBuffer.loadFromFile("resources/sound/out_of_time.wav");
	Sound outOfTime;
	...
	while (window.isOpen())
	{
		...
		*/
		...
		if (Keyboard::isKeyPressed(Keyboard::Return) )
		{
			...
			// Make all the branches dusappear - 
		...
		if (acceptInput)
		{
			...
			if (Keyboard::isKeyPressed(Keyboard::Left) )
			{
				...
				// Add to yhe amount of time remaining
				timeRemaining += (2 / score) + .15;
		...
		*/
		if (!paused)
		{
			...
			// Subtrack from the amount of time remaining
				...
				// Move the bee
			{
				...
				{
					// Set it up ready to whole new bee next frame
					beeActive = false;
				}
			}
			...
			for (int i = 0; i < NUM_BRANCHES; i++)
			{
				...
				{
					// Move the sprite to the last side
